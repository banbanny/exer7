        ...
        <div className="h-screen max:h-screen-auto flex justify-center items-center bg-bg-color">
            <div className="w-1/2 rounded-md bg-box-color flex justify-between flex-col font-mono">
                ...
                <div className="flex w-full items-center justify-around my-4">
                    <span className="cursor-pointer py-1 px-2 bg-custom-profile rounded-md text-white" onClick={()=>setVisibility("profile")}>Update Profile</span>
                    <span className="cursor-pointer py-1 px-2 bg-custom-prof rounded-md text-white" onClick={()=>setVisibility("password")}>Change Password</span>
                </div>
